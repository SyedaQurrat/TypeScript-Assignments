...
let vehiclesName : string[]= ["bike" , "car" , "aeroplane" ,"boat"];

//producing error ! by Accessing invalid index of array:

// console.log(vehiclesName[4]);     result in terminal   unddefined
...
console.log(vehiclesName [2]);   // result in terminal   aeroplane
